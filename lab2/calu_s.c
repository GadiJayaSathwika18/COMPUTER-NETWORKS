...
recvfrom(s_sock, n, sizeof(n), 0, (struct sockaddr*)&client,
&client_len);
a=atoi(n);
printf("enter second number Client\n");
recvfrom(s_sock, n1, sizeof(n1), 0, (struct sockaddr*)&client,
&client_len);
b=atoi(n1);
...
sendto(s_sock, res, sizeof(res), 0, (struct sockaddr*)&client,
sizeof(client));
